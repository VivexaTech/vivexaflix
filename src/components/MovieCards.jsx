...
export default function MovieCard({ title, poster, date, popularity, id }) {
    ...
    return (
        <>
            <div className="col-12 col-sm-6 col-lg-4 col-xl-3 mb-5">
                <div className="result-card">
                    <img src={`https://image.tmdb.org/t/p/w500/${poster}`} alt={title} className="movie-img" />                    <div className="result-body">
                        ...
                        <div className="d-grid">
                            <Link to={`/preview/${id}`} className="btn btn-watch">
